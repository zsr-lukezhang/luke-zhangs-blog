...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'f69cea58e7b3427294cff40461dc5fd8,en:f69cea58e7b3427294cff40461dc5fd8',
  ...
  process.env.NEXT_PUBLIC_APPEARANCE || 'auto', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个初中生, Hi，我是一个普通人,Hi，我是一个编程爱好者,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Luke Zhang', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的初中生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lukezhang.win', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Luke Zhang, 初中生,博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'admin@lukezhang.win', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'x.com/LukeZhang_WIN', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'github.com/zsr-lukezhang/', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/3537109172357757', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@LukeZhangWIN', // Youtube主页
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://download.lukezhang.win/api/raw/?path=/Pictures/Info.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      name: 'Alpha',
      artist: 'C418',
      url: 'https://download.lukezhang.win/api/raw/?path=/Music/Minecraft%20Volume%20Alpha%20%26%20Beta/C418-Alpha.flac',
      cover:
        'https://upload.wikimedia.org/wikipedia/en/0/08/Minecraft_-_Volume_Beta.jpeg'
    },
    {
      name: 'Minecraft',
      artist: 'C418',
      url: 'https://download.lukezhang.win/api/raw/?path=/Music/Minecraft%20Volume%20Alpha%20%26%20Beta/C418-Minecraft.flac',
      cover:
        'https://upload.wikimedia.org/wikipedia/en/5/5f/Minecraft_%E2%80%93_Volume_Alpha.jpeg'
    }
  ],
